...
# 모듈 임포트  
# 
if __name__ == "__main__": # 이거 쓰면 그 파일 내부적으로는 작동하지만 외부파일(모듈)에서 임포트해 사용할떄는 작동하지 않는다



>>> a = mod2.Math() # 다른 묘듈에 있는 Math 클래스를 사용하는것
>>> print(a.solv(2))
12.566368
...
try-finally: 오류 발생 여부와 상관없이 무조건 실행될 코드
...
pythonCopytry:
    ...
    pass  # 아무것도 안 하고 그냥 넘어감




일부러 오류 발생시키기: raise 사용
pythonCopyif 조건:
    raise 오류  # 강제로 오류 발생  